...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a class="brand-link">
        ...
        <span class="brand-text font-weight-light">Admin I-techverse</span>
    </a>
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="enquiries" class="nav-link">
                        <i class="nav-icon fa fa-info text-warning"></i>
                        <p>Enquiries</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="./contact-leads" class="nav-link">
                        <i class="nav-icon fa fa-phone text-info"></i>
                        <p class="text">Contact Leads</p>
                    </a>
                </li>
                <li class="nav-item">
